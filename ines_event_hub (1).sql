...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 02:11 PM
...
CREATE TABLE `admins` (
  ...
  `role` enum('admin','organizer') DEFAULT NULL
...
(3, 'INES-2026-22952', 3, 'uwase hiba', 'mwamikazihiba@gmail.com', '0798628176', 2, 20000.00, 'paid', '2026-03-03 10:09:10');
...
(3, 'uwase', '$2y$10$R7RCkBuznufp6wgtTfkituJ9zJhzoKbmcYvjxaD4NrYHZqTojyk0O', 'musoni', 'admin', '2026-03-03 12:27:16'),
(4, 'imari', '$2y$10$0dSaUQoUmjmCPxMDkSpPS.VRzYSEgE56EF7qU36.B5coUjtw5rX9C', 'musoni', 'admin', '2026-03-03 12:42:02');
